...
- We do not track you across other companies' apps or websites, and we do not share your data with data brokers.
- Optional analytics (Google Analytics, configured as first-party product analytics with advertising features disabled) are only activated if you explicitly allow them through the cookie consent banner or cookie preferences dialog. You may change this choice at any time from the in-app cookie preferences control (Settings → Data & privacy → Cookie preferences).
