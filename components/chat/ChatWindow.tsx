...
export function ChatWindow({
  ...
  return (
    ...
    >
      ...
      <div className="sticky inset-x-0 bottom-0 z-20 mt-auto shrink-0 bg-gradient-to-t from-background/60 via-background/20 to-transparent px-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-4 sm:px-4 sm:pb-[calc(1rem+env(safe-area-inset-bottom))] sm:pt-6 md:px-6">
