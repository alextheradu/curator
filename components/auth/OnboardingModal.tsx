    ...
    <Dialog open={open && !isComplete} onOpenChange={() => {}}>
      ...
      >
        <div className="border-b border-border/60 px-6 py-5">
          <DialogHeader className="gap-2 text-left">
            ...
            <DialogTitle className="text-lg font-semibold text-foreground">
              ...
              {step === 2 && "What team are you on?"}
              {step === 3 && "Choose your default chat mode"}
            </DialogTitle>
            <p className="text-sm leading-6 text-muted-foreground">
              {step === 1 && "This name appears in your saved account profile and is used in chat context."}
              {step === 2 && "Your saved team number lets Curator pull The Blue Alliance context for your team."}
              {step === 3 && "You can still change this later from Settings."}
            </p>
          </DialogHeader>
        </div>
        ...
        <DialogFooter className="border-t border-border/60 px-6 py-4 sm:justify-between">
          ...
          <Button onClick={step === STEP_COUNT ? () => void handleComplete() : handleNext} disabled={isSaving}>
